...
public class Button_CSS extends AllWidgetsProjectMain_Class{
...
//    driver.navigate().to(Main_Class.baseUrl);
  ...
  public static void tearDown() throws Exception {
	Tools.snapshot((TakesScreenshot)driver, AllWidgetsProjectMain_Class.allwidgets,Button_CSS.class);
	driver.quit();
