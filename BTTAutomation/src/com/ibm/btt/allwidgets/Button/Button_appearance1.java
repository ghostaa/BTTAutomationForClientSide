...
public class Button_appearance1 extends AllWidgetsProjectMain_Class{
...
//    driver.navigate().to(Main_Class.baseUrl);
  ...
  public static void tearDown() throws Exception {
	Tools.snapshot((TakesScreenshot)driver, AllWidgetsProjectMain_Class.allwidgets,Button_appearance1.class);
	driver.quit();
