...
public class CheckBox_appearance2 extends AllWidgetsProjectMain_Class{
...
//    driver.navigate().to(Main_Class.baseUrl);
  ...
  public static void tearDown() throws Exception {
	Tools.snapshot((TakesScreenshot)driver, AllWidgetsProjectMain_Class.allwidgets,CheckBox_appearance2.class);
	driver.quit();
