...
public class CSS {
  ...
  public static void setUp() throws Exception {
    ...
    driver.findElement(By.id("CheckedMultiSelect_main_link02")).click();
    WebElement Third_css=driver.findElement(By.xpath("//div[@id='CheckedMultiSelect_css_panel']//form[@id='CheckedMultiSelect_css_form']//div[@id='widget_CheckedMultiSelect_css_checkedMultiSelect_copy01']"));
    System.out.println("Third_css+"+Third_css.getAttribute("class"));

    WebElement Second_css=driver.findElement(By.xpath(".//*[@id='widget_CheckedMultiSelect_css_checkedMultiSelect_copy']"));
    System.out.println("The second css:"+Second_css.getAttribute("class"));
    
    WebElement First_css=driver.findElement(By.xpath(".//*[@id='widget_CheckedMultiSelect_css_checkedMultiSelect_copy_copy']"));
    System.out.println("The first css:"+First_css.getAttribute("class"));

    WebElement Forth_css=driver.findElement(By.xpath(".//*[@id='widget_CheckedMultiSelect_css_checkedMultiSelect_copy01_copy']/div[2]"));
    System.out.println("The fourth css:"+Forth_css.getAttribute("class"));
...
*/    
  ...
  public int css_query(String css,String[] temp)
  { int num=0;
  ...
  @Test
  public void First_css(){
	  String Fcss=null;
	  Fcss=driver.findElement(By.xpath(".//*[@id='widget_CheckedMultiSelect_css_checkedMultiSelect_copy_copy']")).getAttribute("class");
	  String[] temp={"setFontStyle"};
	 assertEquals(1,css_query(Fcss,temp));
	  //WebElement btn=driver.findElement(By.id(("dijit_form_CheckBox_40")));
	  //assertFalse(btn.isEnabled());
  }
  @Test
  public void Second_css(){
	  String Scss=null;
	  Scss=driver.findElement(By.xpath(".//*[@id='widget_CheckedMultiSelect_css_checkedMultiSelect_copy']")).getAttribute("class");
	  String[] temp={"setFontStyle","setFontSize"};
	  assertEquals(2,css_query(Scss,temp));
  }
  
  @Test
  public void Third_css(){
	  String Tcss=null;
	  Tcss=driver.findElement(By.xpath("//div[@id='CheckedMultiSelect_css_panel']//form[@id='CheckedMultiSelect_css_form']//div[@id='widget_CheckedMultiSelect_css_checkedMultiSelect_copy01']")).getAttribute("class");
	  String[] temp={"setFontStyle","setFontSize","setFontWeight"};
	  assertEquals(3,css_query(Tcss,temp));
  }
