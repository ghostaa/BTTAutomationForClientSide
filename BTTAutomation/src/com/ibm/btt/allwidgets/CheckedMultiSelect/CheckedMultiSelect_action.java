...
public class CheckedMultiSelect_action extends AllWidgetsProjectMain_Class{
...
/*  @Test
  ...
  public static void tearDown() throws Exception {
	Tools.snapshot((TakesScreenshot)driver, AllWidgetsProjectMain_Class.allwidgets,CheckedMultiSelect_action.class);
	driver.quit();
