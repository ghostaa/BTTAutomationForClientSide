...
public class CheckedMultiSelect_condition extends AllWidgetsProjectMain_Class{
...
/*  @Test
  ...
  public static void tearDown() throws Exception {
	Tools.snapshot((TakesScreenshot)driver, AllWidgetsProjectMain_Class.allwidgets,CheckedMultiSelect_condition.class);
	driver.quit();
