...
public class CheckedMultiSelect_event extends AllWidgetsProjectMain_Class{
  ...
  public static void tearDown() throws Exception {
	Tools.snapshot((TakesScreenshot)driver, AllWidgetsProjectMain_Class.allwidgets,CheckedMultiSelect_event.class);
	driver.quit();
