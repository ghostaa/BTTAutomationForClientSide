...
public class Combo_Event extends AllWidgetsProjectMain_Class{
  ...
  public static void tearDown() throws Exception {
	Tools.snapshot((TakesScreenshot)driver, AllWidgetsProjectMain_Class.allwidgets,Combo_Event.class);
	driver.quit();
