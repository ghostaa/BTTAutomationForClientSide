...
public class HorizontalSlider_appearance1 extends Main_Class{
  ...
  public static void setUp() throws Exception {
    ...
    drv.HorizontalSlider_appearance1();
  }
  ...
  public void Appearance1_2(){
	  assertEquals("width: 400px;", drv.Appearance1_2());
  }
  
  @Test
  public void Appearance1_3(){
	  assertEquals("width: 100%;", drv.Appearance1_3());
  }
  
  @Test
  public void Appearance1_4(){
	  assertEquals("width: 80%;", drv.Appearance1_4());
  }
  
  @AfterClass
  public static void tearDown() throws Exception {
	Tools.snapshot((TakesScreenshot)driver, Main_Class.allwidgets,HorizontalSlider_appearance1.class);
	driver.quit();
