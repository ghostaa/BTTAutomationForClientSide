...
public class HorizontalSlider_appearance2 extends AllWidgetsProjectMain_Class{
  ...
  public static void setUp() throws Exception {
    ...
    drv.HorizontalSlider_appearance2();
  }
  ...
  public static void tearDown() throws Exception {
	Tools.snapshot((TakesScreenshot)driver, AllWidgetsProjectMain_Class.allwidgets,HorizontalSlider_appearance2.class);
	driver.quit();
