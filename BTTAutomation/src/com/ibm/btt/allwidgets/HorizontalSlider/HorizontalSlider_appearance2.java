...
public class HorizontalSlider_appearance2 extends Main_Class{
  ...
  public static void tearDown() throws Exception {
	Tools.snapshot((TakesScreenshot)driver, Main_Class.allwidgets,HorizontalSlider_appearance2.class);
	driver.quit();
