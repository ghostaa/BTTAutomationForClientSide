...
public class Link_appearance2 extends AllWidgetsProjectMain_Class{
  ...
  public static void tearDown() throws Exception {
	Tools.snapshot((TakesScreenshot)driver, AllWidgetsProjectMain_Class.allwidgets,Link_appearance2.class);
	driver.quit();
