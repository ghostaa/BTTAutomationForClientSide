...
public class Radio_Action extends AllWidgetsProjectMain_Class{
 /* private static WebDriver driver;
  ...
  public void Radio_Condition_radio_isFocusable(){
	  assertEquals(2, drv.Radio_Action_Radio_Focus());
  }
  ...
  public static void tearDown() throws Exception {
	Tools.snapshot((TakesScreenshot)driver, AllWidgetsProjectMain_Class.allwidgets,Radio_Action.class);
    driver.quit();
