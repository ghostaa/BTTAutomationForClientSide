...
public class RepetitivePanel_Appearance2 extends Main_Class{
  ...
  public static void tearDown() throws Exception {
	Tools.snapshot((TakesScreenshot)driver, Main_Class.allwidgets,RepetitivePanel_Appearance2.class);
    driver.quit();
