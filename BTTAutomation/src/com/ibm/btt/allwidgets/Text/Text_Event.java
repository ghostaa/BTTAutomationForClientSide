...
public class Text_Event extends AllWidgetsProjectMain_Class{
 /* private static WebDriver driver;
  ...
  public static void tearDown() throws Exception {
	Tools.snapshot((TakesScreenshot)driver, AllWidgetsProjectMain_Class.allwidgets,Text_Event.class);
    driver.quit();
