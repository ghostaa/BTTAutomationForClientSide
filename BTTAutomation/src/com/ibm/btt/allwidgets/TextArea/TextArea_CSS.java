...
public class TextArea_CSS extends AllWidgetsProjectMain_Class{
  ...
  public static void tearDown() throws Exception {
	Tools.snapshot((TakesScreenshot)driver, AllWidgetsProjectMain_Class.allwidgets,TextArea_CSS.class);
    driver.quit();
