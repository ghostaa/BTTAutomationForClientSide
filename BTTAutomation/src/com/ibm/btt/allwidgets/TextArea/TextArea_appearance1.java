...
public class TextArea_appearance1 extends Main_Class{
  ...
  public void Appearance1_5(){
	  assertEquals("visibility: inherit; width: 150px;", drv.Appearance1_5());
  }
  
  @Test
  public void Appearance1_6(){
	  assertEquals("visibility: inherit; height: 50px; width: 150px;", drv.Appearance1_6());
  }
  
  @Test
  public void Appearance1_7(){
	  assertEquals("visibility: inherit; height: 50%; width: 150px;", drv.Appearance1_7());
  }
  
  @Test
  public void Appearance1_8(){
	  assertEquals("visibility: inherit; height: 100%; width: 150px;", drv.Appearance1_8());
  }
  ...
  public void Appearance1_10(){
	  assertEquals("visibility: inherit; height: 50px; width: 50%;", drv.Appearance1_10());
  }
  
  @Test
  public void Appearance1_11(){
	  assertEquals("visibility: inherit; height: 50%; width: 50%;", drv.Appearance1_11());
  }
  
  @Test
  public void Appearance1_12(){
	  assertEquals("visibility: inherit; height: 100%; width: 50%;", drv.Appearance1_12());
  }
  ...
  public void Appearance1_14(){
	  assertEquals("visibility: inherit; height: 50px; width: 100%;", drv.Appearance1_14());
  }
  
  @Test
  public void Appearance1_15(){
	  assertEquals("visibility: inherit; height: 50%; width: 100%;", drv.Appearance1_15());
  }
  
  @Test
  public void Appearance1_16(){
	  assertEquals("visibility: inherit; height: 100%; width: 100%;", drv.Appearance1_16());
  }
