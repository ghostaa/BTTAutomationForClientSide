...
public class TextArea_appearance2 extends Main_Class{
  ...
  public void Appearance2_11(){
	  assertEquals("width: 244px; padding-left: 10%; vertical-align: middle;", drv.Appearance2_11());
  }
 
  @AfterClass
  public static void tearDown() throws Exception {
	Tools.snapshot((TakesScreenshot)driver, Main_Class.allwidgets,TextArea_appearance2.class);
	driver.quit();
