...
public class VerticalSlider_appearance1 extends Main_Class{
  ...
  public static void setUp() throws Exception {
    ...
    drv.VerticalSlider_appearance1();
  }
  ...
  public void Appearance1_2(){
	  assertEquals("height: 100px;", drv.Appearance1_2());
  }
  
  @Test
  public void Appearance1_3(){
	  assertEquals("height: 100%;", drv.Appearance1_3());
  }
  
  @Test
  public void Appearance1_4(){
	  assertEquals("height: 80%;", drv.Appearance1_4());
  }
  
  @AfterClass
  public static void tearDown() throws Exception {
	Tools.snapshot((TakesScreenshot)driver, Main_Class.allwidgets,VerticalSlider_appearance1.class);
	driver.quit();
