...
public class VerticalSlider_appearance2 extends AllWidgetsProjectMain_Class{
  ...
  public static void setUp() throws Exception {
    ...
    drv.VerticalSlider_appearance2();
  }
  ...
  public static void tearDown() throws Exception {
	Tools.snapshot((TakesScreenshot)driver, AllWidgetsProjectMain_Class.allwidgets,VerticalSlider_appearance2.class);
	driver.quit();
