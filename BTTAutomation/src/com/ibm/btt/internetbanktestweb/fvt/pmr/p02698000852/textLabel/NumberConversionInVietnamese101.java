...
//	    driver.navigate().to(Main_Class.baseUrl);
	...
	public void TenTypes_Currency(){
		drv.getAutoFill_button_101().click();
		assertEquals("102 VND",drv.getTenTypes_Text_Currency().getAttribute("value"));
	}
	@Test
	...
	public void TenTypes_result_Text_String(){
		assertEquals("101.8",drv.getTenTypes_Text_Result_String().getAttribute("value"));
	...
	public void TenTypes_result_Text_Currency(){
		assertEquals("102 VND",drv.getTenTypes_Text_Result_Currency().getAttribute("value"));
		assertEquals("VND102,00",drv.getTenTypes_Lable_Result_Currency().getText());
	}
	
	//Number
	@Test
	public void TenTypes_result_Text_Number(){
		assertEquals("102",drv.getTenTypes_Text_Result_Number().getAttribute("value"));
	...
	public void TenTypes_result_Text_Short(){
		assertEquals("102",drv.getTenTypes_Text_Result_Short().getAttribute("value"));
		assertEquals("102",drv.getTenTypes_Lable_Result_Short().getText());
	}
	
	//Integer
	@Test
	public void TenTypes_result_Integer(){
		assertEquals("102",drv.getTenTypes_Text_Result_Integer().getAttribute("value"));
		assertEquals("102",drv.getTenTypes_Lable_Result_Integer().getText());
	}
	
	//Long
	@Test
	public void TenTypes_result_Long(){
		assertEquals("102",drv.getTenTypes_Text_Result_Long().getAttribute("value"));
		assertEquals("102",drv.getTenTypes_Lable_Result_Long().getText());
	}
	
	//Float
	@Test
	public void TenTypes_result_Float(){
		assertEquals("101,80",drv.getTenTypes_Text_Result_Float().getAttribute("value"));
	...
	public void TenTypes_result_Double(){
		assertEquals("101,800",drv.getTenTypes_Text_Result_Double().getAttribute("value"));
	...
	public void TenTypes_result_BigInteger(){
		assertEquals("102",drv.getTenTypes_Text_Result_BigInteger().getAttribute("value"));
		assertEquals("102",drv.getTenTypes_Lable_Result_BigInteger().getText());
	}
	
	//BigDecimal
	@Test
	public void TenTypes_result_BigDecimal(){
		assertEquals("101,800",drv.getTenTypes_Text_Result_BigDecimal().getAttribute("value"));
