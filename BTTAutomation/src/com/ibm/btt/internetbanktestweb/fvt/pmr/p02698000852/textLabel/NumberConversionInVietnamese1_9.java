...
//	    driver.navigate().to(Main_Class.baseUrl);
	...
	public void TenTypes_String(){
		drv.getAutoFill_button_1_9().click();
		assertEquals("123456789.123",drv.getTenTypes_Text_String().getAttribute("value"));
	}
	@Test
	...
	public void TenTypes_Number(){
		drv.getAutoFill_button_1_9().click();
		assertEquals("123.456.789,123",drv.getTenTypes_Text_Number().getAttribute("value"));
	}
	@Test
	public void TenTypes_Short(){
		drv.getAutoFill_button_1_9().click();
		assertEquals("32.765",drv.getTenTypes_Text_Short().getAttribute("value"));
	}
	@Test
	...
	public void TenTypes_Float(){
		drv.getAutoFill_button_1_9().click();
		assertEquals("123.456.789,12",drv.getTenTypes_Text_Float().getAttribute("value"));
	}
	@Test
	public void TenTypes_Double(){
		drv.getAutoFill_button_1_9().click();
		assertEquals("123.456.789,123",drv.getTenTypes_Text_Double().getAttribute("value"));
	}
	@Test
	...
	public void TenTypes_BigDecimal(){
		drv.getAutoFill_button_1_9().click();
		assertEquals("123.456.789,123",drv.getTenTypes_Text_BigDecimal().getAttribute("value"));
	}
	...
	public void TenTypes_result_Text_String(){
		assertEquals("123456789.123",drv.getTenTypes_Text_Result_String().getAttribute("value"));
	...
	public void TenTypes_result_Text_Short(){
		assertEquals("32.765",drv.getTenTypes_Text_Result_Short().getAttribute("value"));
	...
	public void TenTypes_result_Double(){
		assertEquals("123.456.789,123",drv.getTenTypes_Text_Result_Double().getAttribute("value"));
	...
	public void TenTypes_result_BigDecimal(){
		assertEquals("123.456.789,123",drv.getTenTypes_Text_Result_BigDecimal().getAttribute("value"));
