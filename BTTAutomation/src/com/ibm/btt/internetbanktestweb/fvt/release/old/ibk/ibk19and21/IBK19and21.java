...
public class IBK19and21 extends InternetBankTestWebMain_Class{

  private boolean acceptNextAlert = true;
  private static StringBuffer verificationErrors = new StringBuffer();
  private static IBK19and21_PageObject drv;
  ...
  public static void setUp() throws Exception {
    ...
    drv=PageFactory.initElements(driver, IBK19and21_PageObject.class);
...
//###############################close box##################################
  ...
  public static void tearDown() throws Exception {
	Tools.snapshot((TakesScreenshot)driver, InternetBankTestWebMain_Class.InternetBankTestWeb,IBK19and21.class);
	driver.quit();
