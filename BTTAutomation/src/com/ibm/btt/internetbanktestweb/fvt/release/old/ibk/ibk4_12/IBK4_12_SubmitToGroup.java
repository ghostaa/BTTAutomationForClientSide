...
public class IBK4_12_SubmitToGroup extends InternetBankTestWebMain_Class{
	...
	public static void tearDown(){
		Tools.snapshot((TakesScreenshot) driver, InternetBankTestWebMain_Class.InternetBankTestWeb,IBK4_12_SubmitToGroup.class);
		driver.quit();
